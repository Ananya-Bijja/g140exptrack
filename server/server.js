...
// //   try {
// //     if (username.endsWith('@admin')) {
// //       return res.status(200).json({ message: 'Admin login successful', isAdmin: true, user: { username, emotionAnalysis: [] } });
// //     }
...
// //     res.status(200).json({ message: 'Login successful', isAdmin: false, user: { username: user.username, emotionAnalysis: user.emotionAnalysis } });
// //   } catch (error) {
// //     res.status(500).json({ message: 'Error during login', error: error.message });
// //   }
// // });
